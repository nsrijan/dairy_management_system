package com.jaysambhu.modulynx.modules.dairy.factory.repository;

import com.jaysambhu.modulynx.modules.dairy.factory.model.Factory;
...
public interface FactoryRepository extends JpaRepository<Factory, Long> {
    ...
    /**
     * Find factory by code and company ID
     */
    Optional<Factory> findByCodeAndCompany_Id(String code, Long companyId);

    /**
     * Check if factory exists by code and company ID
     */
